/*
function pantalla(turnoElegido, generoElegido, mtzAlumnos){
    alert(mtzAlumnos);
}
*/
...
t01 += "<tr><th>No.</th> <th>Genero</th> <th>Apellidos y Nombres</th> <th>Turno</th> </tr>";
...
if(mtzAlumnos.length > 0) {
    for (var i =0; i < mtzAlumnos.length; i++) {
        ...
        if (turnoMtz == turnoElegido && generoMtz == generoElegido){
            ...
            t01 += "<tr>";
            t01 += "<td> "+orden+"</td> <td>"+genero1+"</td> <td>"+apeNom+" </td> <td> "+turno+" </td>";
